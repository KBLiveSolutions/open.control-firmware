  ...
  if (data[1] == 122 && data[2] == 29 && data[3] == 1 && data[4] == 19) {
    if (data[5] < 30) {
      switch (data[5]) {
        ...
        case 4: { // Receiving {240, 122, 29, 1, 19, 4} from the Editor sends each control 1 by 1 {240, 122, 29, 1, 19, 77, Layout, Control, CC Number, Channel, Type, 247}
            ...
            for ( byte layout_number = 0; layout_number < NUM_LAYOUT; layout_number ++) {
              ...
              for ( byte i = 0; i < NUM_BUTTONS; i += 1) {
                // retrieves and sends short button values
                sysex_to_send[7]  = i;
                ...
                sendUSBSysEx(sysex_to_send, 12);
                // retrieves and sends LEDs values
              ...
              for ( byte i = 0; i < NUM_SLIDERS; i += 1) {
                // retrieves and sends sliders values
              ...
              // retrieves and sends display values
              sysex_to_send[7]  = 20;
            ...
            // retrieves and sends External MIDI values
        ...
        case 10: {    // Sets Short Buttons Type Control and Channel
        ...
        case 11:  {    // Sets Long Buttons Type Control and Channel
            byte rcvd_layout = data[6];
            byte num = data[7];
            byte btn_ctrl = data[8];
            byte btn_type = data[9];
